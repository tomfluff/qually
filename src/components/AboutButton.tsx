            ...
            <div className="about-body nicescroll">
              ...
              <section>
                ...
                <ul>
                  ...
                  <li><b>Assist tab:</b> the AI's observations side by side across participants, grouped by lens or by transcript and filterable to what you haven't coded yet — <b>Code</b> writes a segment for that line (authored by you), <b>Open</b> jumps to it, <b>Dismiss</b> removes it. Both AI runs also start here: the sparkle on a transcript row (or the button above the list) opens the scan or the code-suggestion consent gate for it.</li>
