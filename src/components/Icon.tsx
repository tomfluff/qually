...
const PATHS: Record<string, { d: string[]; fill?: boolean }> = {
  ...
  // Tabler "archive" — set aside, not thrown away
  archive: { d: ["M3 4m0 2a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v1a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2z", "M5 9v9a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-9", "M10 13h4"] },
  ...
  "alert-triangle": { d: ["M12 9v4", "M10.363 3.591l-8.106 13.534a1.914 1.914 0 0 0 1.636 2.871h16.214a1.914 1.914 0 0 0 1.636 -2.87l-8.106 -13.536a1.914 1.914 0 0 0 -3.274 0z", "M12 16h.01"] },
